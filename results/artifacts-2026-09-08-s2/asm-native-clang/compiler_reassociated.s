...
.LBB0_8:                                # =>This Inner Loop Header: Depth=1
	vmovups	64(%rsi,%rcx,4), %zmm5
	vmovups	(%rsi,%rcx,4), %zmm4
	vmovups	128(%rsi,%rcx,4), %zmm6
	vmovups	192(%rsi,%rcx,4), %zmm7
	vmulps	64(%rdi,%rcx,4), %zmm5, %zmm5
	vmulps	(%rdi,%rcx,4), %zmm4, %zmm4
	vmulps	128(%rdi,%rcx,4), %zmm6, %zmm6
	vaddps	%zmm1, %zmm5, %zmm1
	vmulps	192(%rdi,%rcx,4), %zmm7, %zmm5
